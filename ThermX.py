...
def update_calc():
    try:
        ...
        state = {
            ...
            'bundleAlignment': st.session_state.get('s_arr', 'staggered'),
            'tubeLength': st.session_state.s_length,
            'shellDo': st.session_state.s_do,
            'baffleSpacing': st.session_state.get('s_baffle', 0.5),
            'tubeDo': st.session_state.s_t_do,
            'tubeThickness': st.session_state.s_t_th,
            'tubePitch': st.session_state.s_t_pitch,
            'tubePitchLongitudinal': st.session_state.get('s_t_pl', 25.4),
            'tubePasses': st.session_state.get('s_t_passes', 2),
